...
def index(request):
    return HttpResponse("<style> body{background-size:cover;text-align:center;"
                        ...
                        "a{font-size:100px;color:purple;}a:hover{color:pink;}</style>"
                        "<a href=""/home"">HOME</a><br><a href=""/info"">INFO PAGE</a>")
def home(request):
    st = "<style> body{background-size:cover;text-align:center;font-size:50px;color:white;" \
...
def info(request):
    st="<style> body{background-size:cover;text-align:center;font-size:50px;color:white;background-image:url(http://awallpapershub.com/wp-content/uploads/2018/05/Awesome-Minimalist-HD-Wallpaper.jpg)}</style><h1>Info Page</h1><ul>"
